...
category: mcp-tools
description: MCPs descobertos pelo keyhunter (373 total, 93 validados free, 280 pulados/pago)
priority: 85
scope: global
...
> Última execução: 2026-09-10T15:42:58.092Z
> Total descoberto: 373 | Validados (HTTP 200 + free): 93 | Pulados (licença paga/enterprise): 280

## MCPs descobertos (gratuitos + validados HTTP 200)

| Repositório | Linguagem | Estrelas | License | Tópicos | Link |
|---|---|---|---|---|---|
| laurasolares811-creator/Horizon | Python | 0 | MIT |  | [repo](https://github.com/laurasolares811-creator/Horizon) |
| rjriajul/wzgram | Python | 28 | LGPL-3.0 |  | [repo](https://github.com/rjriajul/wzgram) |
| alxxtexxr/arxiv_agent | Python | 0 | MIT | agentic-ai, arxiv-papers, langchain | [repo](https://github.com/alxxtexxr/arxiv_agent) |
| CaryNC-IP/carync-ip.github.io | Python | 0 | MIT |  | [repo](https://github.com/CaryNC-IP/carync-ip.github.io) |
| KurimuzonAkuma/kurigram | Python | 794 | LGPL-3.0 | fork, kurigram, mtproto | [repo](https://github.com/KurimuzonAkuma/kurigram) |
| Kalwmw/Zip-Password-Recovery | Python | 4 | MIT |  | [repo](https://github.com/Kalwmw/Zip-Password-Recovery) |
| Glyxehon/Blum-Crypto-Trading-P2P-Chain-Exchange | Python | 0 | MIT | blockchain-trader, blum, blum-crypto | [repo](https://github.com/Glyxehon/Blum-Crypto-Trading-P2P-Chain-Exchange) |
...
- BryanSapo/info-pulse — licença: unknown
- alabubu/mirequ-pipeline — licença: unknown
- KWMIOK/gal-zu — licença: unknown
- vlad-pisotskyi/learning-forge — licença: unknown
- Cfeesto/pdfbot — licença: unknown
- dkreinov/skill_deck_video — licença: unknown
- mctishke/de7-topics — licença: unknown
- Yonge6/xiazi-global-hot-topics — licença: unknown
- cboudreau-eip/medicarefaq-next — licença: unknown
- moha-osama/Quiz-app — licença: unknown
- VCU-community/vcu-ai-rss — licença: unknown
- MahadBasit/ml-topics — licença: unknown
- rubyrayjuntos/AIML-Engineer-Academy — licença: unknown
- drwiiche/google-trend-morocco — licença: unknown
- graehl/agents — licença: unknown
- maltchev/rfd-ntfy — licença: unknown
- Praveenrathi-05/backend-learning-portfolio — licença: unknown
...
- ashijobs2025-prog/Topic_to_Web — licença: unknown
- kunalsonkar485-png/SmartStudyAI — licença: unknown
- aammuhammad18-cmyk/majeda — licença: unknown
- GustavoPereiraCassiano/Projeto-Topicos — licença: unknown
- phoebefoy17/topicwatch — licença: unknown
- OfentseBaloyi/LEARNFORGE — licença: unknown
- sarathkumar2907/My-Learnings — licença: unknown
- gilhorne/blockchain_engineer — licença: unknown
- amarcu/ai-paper-digest — licença: unknown
- mostypc123/sloppity-slop — licença: unknown
...
- HdxL0V3/repo-tag-topic-tool — licença: unknown
- JayaPramodh/cs50ai — licença: unknown
...
- itsdaddio/ai-prompt-generator — licença: unknown
...
- sacovo/n8n-nodes-ros2 — licença: unknown
...
- AkhileshBhambhani/other-projects — licença: unknown
- anamgiri91/transfer-learning-research — licença: NOASSERTION
- SelrAI-Skool-Community/learning-hub — licença: unknown
- ommegamind/Python-Topics — licença: unknown
- asad1922rfs-wq/-vertex-learning-platform — licença: unknown
...
- zerx-lab/get-topic — licença: unknown
- paula564/G40-A01 — licença: unknown
- aryannvrao/music-playlist-linked-lists — licença: unknown
- Roood-design/tn-assembly-watch — licença: unknown
- ug8yogesh/AI-Learning-Study-Assistant — licença: unknown
...
- Llamalu1/newsapi-email-digest — licença: unknown
- ShubhanshuJha/redis-tutorial — licença: unknown
- joshua2008626/student-score-predictor-ai — licença: unknown
- virajsamarasinghe/kafka-avro-order-processing — licença: unknown
- geromari/Colibri — licença: unknown
